...
% Ontologies were also studied for reasoning services within its expressive formal description. 
...
% interpretation elements and associated concepts for each interpretation element. 
...
% adding a new formula into the theory never guarantee the truth of the conclusion.
...
% The definition of hitting set is introduced below. 
...
% where the explanation is the combination of concepts missing compared to observation.
...
concepts. 
% We consider the concepts are balanced and use the inclusion criteria, cardinality, subsumption and irreducibility for the future.
